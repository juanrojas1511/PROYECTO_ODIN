...
<title>VERSIÓN 3 — Dataset Online</title>
...
body{
    ...
    background-image:
    radial-gradient(circle at top left, rgba(96,165,250,.16), transparent 40%),
...
<div class="badge">VERSIÓN 3</div>

<h1>
Dataset <span>Online</span>
</h1>

<p>
Clasificador KNN · Dataset cargado desde internet
</p>

<div class="tags">
<span class="tag">Flask</span>
<span class="tag">KNN</span>
<span class="tag">Cloud Dataset</span>
<span class="tag">GitHub RAW</span>
...
<p>Dataset conectado a internet</p>
...
if __name__ == "__main__":
    ...
    print("═══════════════════════════════════════")
    print("VERSIÓN 3 — DATASET ONLINE")
    print("Dataset cargado desde internet")
